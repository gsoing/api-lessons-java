...
import documentedition.demo.exception.ForbiddenException;
...
import static documentedition.demo.dto.ErrorMessageType.FUNCTIONAL;
import static documentedition.demo.dto.ErrorMessageType.TECHNICAL;
...
public class ErrorController extends AbstractErrorController {
    ...
    public ResponseEntity<ErrorMessages> handleErrors(HttpServletRequest request) {
        ...
        return ResponseEntity
                .status(status)
                .body(new ErrorMessages(HTTP_STATUS_FUNCTIONAL_ERROR.contains(status) ? FUNCTIONAL : TECHNICAL, builder.build()));
    }
    ...
    private static ErrorMessage.ErrorMessageBuilder unauthorized(ErrorAttributes errorAttributes, HttpServletRequest request) {
        return ErrorMessage.builder()
                .code("err.func.wired.unauthorized")
                .message("The access is unauthorized");
    }

    private static ErrorMessage.ErrorMessageBuilder unknownError(ErrorAttributes errorAttributes, HttpServletRequest request) {
