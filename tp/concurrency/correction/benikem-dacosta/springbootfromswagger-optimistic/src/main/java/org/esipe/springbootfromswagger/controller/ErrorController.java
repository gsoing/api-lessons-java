...
public class ErrorController extends AbstractErrorController {
    ...
    private static final List<HttpStatus> HTTP_STATUS_FUNCTIONAL_ERROR = Arrays.asList(NOT_FOUND, UNAUTHORIZED, FORBIDDEN, CONFLICT, BAD_REQUEST, PRECONDITION_FAILED);
    ...
    static {
        ...
        messages.put(PRECONDITION_FAILED,ErrorController::preconditionFailed);
    ...
    private static ErrorMessage.ErrorMessageBuilder preconditionFailed(ErrorAttributes errorAttributes,
                                                               HttpServletRequest request) {
        return ErrorMessage.builder()
                .errorCode(PreconditionException.PRECONDITION_FAILED_CODE)
                .errorMessage(PreconditionException.PRECONDITION_FAILED_MESSAGE);
    }
